...
if (isset($_POST['submit']) && isset($_FILES['title_img']) && isset($_FILES['image_1']) && isset($_FILES['image_2'])) {
    ...
    if ($error === 0) {
        if ($img_size > 125000) {
            ...
            header("Location: admin_tours_add.php?error=$em");
        } else if ($img_size1 > 50000000) {
            $em = "Sorry, your file is too large.";
            header("Location: admin_tours_add.php?error1=$em");
        } else if ($img_size2 > 50000000) {
            $em = "Sorry, your file is too large.";
            header("Location: admin_tours_add.php?error2=$em");
        } else if ($img_size3 > 50000000) {
            $em = "Sorry, your file is too large.";
            header("Location: admin_tours_add.php?error3=$em");
        } else if ($img_size4 > 50000000) {
            $em = "Sorry, your file is too large.";
            header("Location: admin_tours_add.php?error4=$em");
        } else if ($img_size5 > 50000000) {
            $em = "Sorry, your file is too large.";
            header("Location: admin_tours_add.php?error5=$em");
        } else {
    ...
    header("Location: admin_tours_add.php");
}
