    ...
    <div class="d-none d-lg-block">
        <div class="row bg-light p-3 mb-5 div-rounded">
            <div class="col-4 ps-4 text-dark text-start">
                <label for="" class="form-label ps-2"><i
                        class="bi bi-geo-alt me-2"></i>Destination</label>
            ...
            <div class="col-3 text-dark text-start">
                <label for="" class="form-label ps-2"><i class="bi bi-calendar-check me-2"></i>Check
                    in</label>
                <input type="date" class="form-control div-rounded-less" placeholder="Check in"
                    aria-label="Check in">
            </div>
            <div class="col-3 text-dark text-start">
                <label for="" class="form-label ps-2"><i class="bi bi-calendar-minus me-2"></i>Check
                    out</label>
                <input type="date" class="form-control div-rounded-less" placeholder="Check out"
                    aria-label="Check out">
            </div>
            <div class="col-2">
                <button
                    class="btn btn-secondary div-rounded-less px-xxl-4 py-xxl-2 my-3">SEARCH</button>
            </div>
        </div>
    </div>
